    ...
    if (q1var == 1) { // Good organisation
      if (q2var == 1) { // Planned
        if (q3var == 1) { // Small
          ...
          $('#SummaryText2').text('This framework forces you to think beyond what you want – to how you will get there.');
        } else if (q3var == 2) { // Big
          ...
          $('#SummaryText2').text('Take 1 minute right now to go to your calendar. Block out 1 hour timeboxes for the rest of the day and title them with what you want to focus on during each hour (don’t forget about breaks after each timebox + lunch and dinner).');
        }
      ...
      $('#FocuspediaLink').text('📖 Read more in the Focuspedia (Ingredient #1)');
      $('#FocuspediaLink').attr("href","https://fastasarocket.com/focuspedia/ingredient1");
      $('#RocketLink').text('🚀 Like this tip? Then you will love Rocket. Among other things it makes good organisation easy. Tap here for more info.');
      ...
      if (q3var == 1) { // Small
        if (q2var == 1) { // Planned
          ...
          $('#SummaryText2').text('If you’re not using Rocket, one way to remember to turn it on is by using this habit stacking technique: after you look at your to-do list, turn your phone on Do Not Disturb.');
        }
      } else if (q3var == 2) { // Big
        $('#SummaryTitle').text('Don’t use your phone first thing in the morning!');
      ...
      $('#FocuspediaLink').text('📖 Read more in the Focuspedia (Ingredient #2)');
      $('#FocuspediaLink').attr("href","https://fastasarocket.com/focuspedia/ingredient2");
      $('#RocketLink').text('🚀 Like this tip? Then you will love Rocket. Among other things it makes getting in the habit of eliminating distractions easier. Tap here for more info.');
      ...
      if (q3var == 1) { // Small
        if (q2var == 1) { // Planned
          ...
          $('#SummaryText2').text('There is also a clear benefit to concentration on the days you exercise compared to days when you do not exercise – so while you’re at it integrate exercise, even just a brief amount, into your daily routine.');
        }
      }
      $('#FocuspediaLink').text('📖 Read more in the Focuspedia (Extra Ingredients)');
      $('#FocuspediaLink').attr("href","https://fastasarocket.com/focuspedia/extra-ingredients");
      $('#RocketLink').text('🚀 Like this tip? Then you will love Rocket. Tap here for more info.');
      ...
      if (q3var == 1) { // Small
        ...
        $('#SummaryText').text('Trying to focus but suddenly get the urge to do something you shouldn’t be doing? These scenarios are the perfect application of the ‘surfing the urge 10-minute rule’ which you should get in the habit of using.');
        $('#SummaryText2').text('1. Write down what you want to do so you don’t forget it. 2. Wait just 10 minutes. 3. If you still want to act on the urge after the 10 minutes is up, feel free to do it, but that is rarely the case.');
      }
      $('#FocuspediaLink').text('📖 Read more in the Focuspedia (Ingredient #4)');
      $('#FocuspediaLink').attr("href","https://fastasarocket.com/focuspedia/ingredient4");
      $('#RocketLink').text('🚀 Like this tip? Then you will love Rocket. Among other things it helps you keep aware of where your attention is going and helps you resist urges more easily. Tap here for more info.');
      ...
      if (q3var == 1) { // Small
        if (q2var == 1) { // Planned
          ...
          $('#SummaryText').text('Work can be intensely rewarding in the long term, so we just need to work some magic to carry over that motivation to the short term too. In essence, we want to reward ourselves more when we’re doing the things we want (in this case, focusing on work). You can turn breaks into an opportunity to celebrate small wins throughout the day.');
          $('#SummaryText2').text('Take frequent breaks and reward yourself with a snack, a walk or even a coffee with a friend. This can help make work feel more fun even if the work you need to do isn’t very intrinsically rewarding.');
        }
      } else if (q3var == 2) { // Big
        if (q2var == 1) { // Planned
          $('#SummaryTitle').text('Reward yourself with frequent breaks!');
          ...
          $('#SummaryText').text('Even repetitive and boring tasks can be reimagined into a challenge as a very effective way to get into a deep state of focus. If you’re creative you can create an infinite number of intrinsically motivating challenges anywhere you look. Trying to get through a bunch of boring emails? Why not challenge yourself to do 1 email per minute?');
          $('#SummaryText2').text('Here’s a challenge for you: next time you want to focus challenge yourself to focus 100% of your attention on the task at hand for a full 25 minute timer (it may be harder than you think).');
        }
      }
      $('#FocuspediaLink').text('📖 Read more in the Focuspedia (Ingredient #3)');
      $('#FocuspediaLink').attr("href","https://fastasarocket.com/focuspedia/ingredient3");
      $('#RocketLink').text('🚀 Like this tip? Then you will love Rocket. Among other things it makes it easy to stay motivated on whatever you want or need to focus on. Tap here for more info.');
  
    } else if (q1var == 6) {
      if (q3var == 1) { // Small
        if (q2var == 1) { // Planned
          $('#SummaryTitle').text('Work somewhere public and productive!');
          $('#SummaryText').text('If your workplace has built up an atmosphere of productivity, you are less likely to spend all day scrolling through Instagram there because you’ll feel guilty that all your colleagues are working well and you’re not.');
          $('#SummaryText2').text('Working at home or in an office space? Join a thriving co-working space – even if it’s just 1 day per week.');
        } else if (q2var == 2) { // Flexible
          $('#SummaryTitle').text('Create a pact that you don’t want to lose!');
          $('#SummaryText').text('If you’re serious about something, and that something isn’t happening, it might be time to create an equally serious pact with yourself.');
        ...
        $('#SummaryText').text('3…2…1… Often we use these countdowns to tell ourselves we’re going to do something after a few seconds. And it works, which is why we do it.');
        $('#SummaryText2').text('Likewise, a timer is a simple and powerful way to use your commitment bias to your advantage – so you stick to focus for the period of time you wanted to. Start using 25 minute timers (a very popular length of time).');
      }
      $('#FocuspediaLink').text('📖 Read more in the Focuspedia (Ingredient #5)');
      $('#FocuspediaLink').attr("href","https://fastasarocket.com/focuspedia/ingredient5");
      $('#RocketLink').text('🚀 Like this tip? Then you will love Rocket. Among other things it helps you keep accountable with yourself and with friends. Tap here for more info.');
    }
